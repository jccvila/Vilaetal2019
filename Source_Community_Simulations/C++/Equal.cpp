...
//    // read command line data
    ...
    jm_vect.push_back(50);
    jm_vect.push_back(92);
    jm_vect.push_back(167);
    jm_vect.push_back(303);
    jm_vect.push_back(674);
    jm_vect.push_back(1005);
    jm_vect.push_back(1830);
    jm_vect.push_back(3335);
    jm_vect.push_back(6077);
    jm_vect.push_back(11071);

    nu_vect.push_back(0);
    nu_vect.push_back(0.00001);
    nu_vect.push_back(0.00003);
    nu_vect.push_back(0.00007);
    nu_vect.push_back(0.0002);
    nu_vect.push_back(0.0005);
    nu_vect.push_back(0.001);
    nu_vect.push_back(0.004);
    ...
    s_vect.push_back(0.0003);
    s_vect.push_back(0.0007);
    s_vect.push_back(0.002);
    s_vect.push_back(0.005);
    s_vect.push_back(0.01);
    s_vect.push_back(0.04);
    s_vect.push_back(0.1);
    s_vect.push_back(0.3);
